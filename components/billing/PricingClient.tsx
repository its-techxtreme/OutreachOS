  ...
  return (
    <div className="paper-texture min-h-screen">
      <main className="mx-auto flex w-full max-w-4xl flex-col gap-8 px-4 py-8 sm:px-6 sm:py-12">
        <header className="doodle-border bg-paper px-5 py-6">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {(['INR', 'USD'] as const).map((code) => (
            <button
              ...
              className={cn(
                'rounded border-2 border-ink px-3 py-1 text-sm font-semibold',
                currency === code
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <section className="doodle-border bg-paper p-5">
            ...
            <Button asChild className="mt-6 doodle-btn w-full" variant="outline">
          ...
          <section className="doodle-border border-ink bg-highlighter/40 p-5">
            ...
            {plan === 'admin' ? (
              ...
              <p className="mt-6 text-sm font-semibold">You are on Premium.</p>
            ) : (
              <Button
                type="button"
        ...
        <p className="text-sm text-ink-muted">
          ...
          opens a message to{' '}
          <a className="underline" href={`mailto:${PREMIUM_REQUEST_EMAIL}`}>
